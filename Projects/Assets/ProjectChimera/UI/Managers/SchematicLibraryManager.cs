...
namespace ProjectChimera.UI.Managers
{
    ...
    public class SchematicLibraryManager : MonoBehaviour
    {
        ...
        [SerializeField] private SchematicLibraryPanel _libraryPanel;
        ...
        [Header("Integration")]
        [SerializeField] private ConstructionPaletteManager _paletteManager;
        ...
        private void FindReferences()
        {
            ...
            {
                _paletteManager = FindObjectOfType<ConstructionPaletteManager>();
            }
        ...
        private void LoadSchematicsImmediate()
        {
            ...
            Debug.Log($"[SchematicLibraryManager] Loaded {_loadedSchematicsCount} schematics immediately");
        }
        ...
        private System.Collections.IEnumerator LoadSchematicsAsync()
        {
            ...
            OnSchematicsLoaded?.Invoke(_loadedSchematicsCount);
            Debug.Log($"[SchematicLibraryManager] Loaded {_loadedSchematicsCount} schematics asynchronously");
        }
        ...
        private void LoadPreferences()
        {
            if (_autoSavePreferences && PlayerPrefs.HasKey(_preferencesKey))
            {
                ...
                {
                    Debug.LogWarning($"[SchematicLibraryManager] Failed to load preferences: {e.Message}");
        ...
        // Event handlers
        private void OnSchematicSelectedFromLibrary(SchematicSO schematic)
        {
            OnSchematicSelectedInLibrary?.Invoke(schematic);
        }
        
        private void OnSchematicAppliedFromLibrary(SchematicSO schematic)
        {
            Debug.Log($"[SchematicLibraryManager] Schematic applied from library: {schematic.SchematicName}");
            
            // Update usage statistics
            _preferences.UpdateUsageStats(schematic.name);
            SavePreferences();
        }
        
        private void OnSchematicDeletedFromLibrary(SchematicSO schematic)
        {
