...
namespace ProjectChimera.Systems.Environment
{
    ...
    public class GrowLightSpectrumController : MonoBehaviour
    {
        ...
        /// </summary>
        public float GetSpectrumEffectiveness(PlantGrowthStage growthStage)
        {
            switch (growthStage)
            {
        ...
        private void LogDebug(string message)
        {
            if (_enableSpectrumLogging)
                Debug.Log($"[GrowLightSpectrumController] {message}");
        }
        
        private void LogError(string message)
        {
            Debug.LogError($"[GrowLightSpectrumController] {message}");
        }
    }
