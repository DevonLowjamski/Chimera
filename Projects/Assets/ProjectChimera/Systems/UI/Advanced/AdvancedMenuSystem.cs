...
namespace ProjectChimera.Systems.UI.Advanced
{
    ...
    public class AdvancedMenuSystem : MonoBehaviour
    {
        ...
        {
            _serviceCoordinator = FindObjectOfType<ServiceLayerCoordinator>();
            _visualFeedback = FindObjectOfType<VisualFeedbackSystem>();
            ...
            if (_menuConfig == null)
            {
                Debug.LogWarning("[AdvancedMenuSystem] No menu config assigned - using default settings");
        ...
        private void SetupMenuUI()
        {
            ...
            {
                Debug.LogError("[AdvancedMenuSystem] UIDocument component required for advanced menu system");
                return;
            }
        ...
        public void RegisterCategory(MenuCategory category)
        {
            ...
            {
                Debug.LogWarning($"[AdvancedMenuSystem] Category {category.Id} already registered");
                return;
            }
        ...
        public void RegisterAction(MenuAction action)
        {
            ...
            {
                Debug.LogWarning($"[AdvancedMenuSystem] Action {action.Id} already registered");
                return;
            }
        ...
        public void ExecuteAction(string actionId, MenuContext context)
        {
            ...
            {
                Debug.LogError($"[AdvancedMenuSystem] Action {actionId} not found");
                return;
            }
            ...
            {
                Debug.LogError($"[AdvancedMenuSystem] Error executing action {actionId}: {ex.Message}");
        ...
        private void ShowFeedback(string message, bool isSuccess)
        {
            ...
            {
                if (isSuccess)
                    Debug.Log($"[AdvancedMenuSystem] {message}");
                else
                    Debug.LogWarning($"[AdvancedMenuSystem] {message}");
            }
        }
