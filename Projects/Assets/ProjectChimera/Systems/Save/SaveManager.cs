...
namespace ProjectChimera.Systems.Save
{
    ...
    /// </summary>
    public class SaveManager : DIChimeraManager, ProjectChimera.Core.IOfflineProgressionListener
    {
        ...
        public bool DeleteSaveSlot(string slotName) => _saveStorage?.DeleteFileAsync(slotName, true).Result?.Success ?? false;
        ...
        {
            var storageInfo = _saveStorage?.GetStorageInfoAsync().Result;
            if (storageInfo != null)
            {
