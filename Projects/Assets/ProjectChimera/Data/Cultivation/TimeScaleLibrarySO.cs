...
namespace ProjectChimera.Data
{
    ...
    public class TimeScaleLibrarySO : ChimeraDataSO
    {
        ...
        public float GetDynamicTimeScale(CultivationGameState gameState, PlayerState playerState)
        {
        ...
        private bool EvaluateRule(DynamicScaleRule rule, CultivationGameState gameState, PlayerState playerState)
        {
    ...
    [System.Serializable]
    public class CultivationGameState
    {
