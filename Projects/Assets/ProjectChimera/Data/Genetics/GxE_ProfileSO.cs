...
namespace ProjectChimera.Data.Genetics
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "New GxE Profile", menuName = "Project Chimera/Genetics/GxE Profile")]
    public class GxE_ProfileSO : ChimeraDataSO
    {
        ...
        [SerializeField] private List<TraitType> _targetTraits = new List<TraitType>();
        ...
        public List<TraitType> TargetTraits => _targetTraits;
        ...
        public float CalculateEnvironmentalModifier(TraitType trait, EnvironmentalConditions environment, float geneticValue, GeneDefinitionSO gene = null)
        {
        ...
        /// </summary>
        public float CalculateStressResponse(TraitType trait, EnvironmentalConditions environment, float currentStressLevel)
        {
        ...
        private float GetEnvironmentalFactorValue(EnvironmentalConditions environment, EnvironmentalFactor factor)
        {
            switch (factor)
            {
        ...
        private float CalculatePhenotypicPlasticity(EnvironmentalConditions environment)
        {
        ...
        private float CalculateOverallStressLevel(EnvironmentalConditions environment)
        {
