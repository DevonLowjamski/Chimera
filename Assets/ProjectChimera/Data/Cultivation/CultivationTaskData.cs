...
namespace ProjectChimera.Data.Cultivation
{
    ...
    public class CareAction
    {
        ...
        /// </summary>
        public bool CanPerform(PlayerCultivationState playerState, EnvironmentalConditions environment)
        {
    ...
    public class EnvironmentalRequirement
    {
        ...
        public bool IsMet(EnvironmentalConditions conditions)
        {
            var value = conditions.GetValue(Factor);
            return value >= MinValue && value <= MaxValue;
        }
        
        public float GetOptimalityScore(EnvironmentalConditions conditions)
        {
            var value = conditions.GetValue(Factor);
