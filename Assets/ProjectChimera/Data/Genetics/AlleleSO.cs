...
namespace ProjectChimera.Data.Genetics
{
    ...
    public class AlleleSO : ChimeraDataSO
    {
        ...
        public float CalculateTraitEffect(TraitType trait, EnvironmentalConditions environment = default)
        {
            ...
            if (_environmentallySensitive && !environment.Equals(default(EnvironmentalConditions)))
            {
        ...
        /// </summary>
        private float CalculateEnvironmentalEffect(EnvironmentalConditions environment)
        {
            float modifier = 1f;
        ...
        private bool IsBiochemicalTrait(TraitType trait)
        {
            return trait == TraitType.THCPotency ||
                   trait == TraitType.CBDContent ||
                   trait == TraitType.TerpeneProduction ||
                   trait == TraitType.FlavonoidContent;
        }
        ...
        /// </summary>
        public float CalculateFitness(EnvironmentalConditions environment)
        {
            float fitness = 1f;
    ...
    {
        public TraitType SecondaryTrait;
