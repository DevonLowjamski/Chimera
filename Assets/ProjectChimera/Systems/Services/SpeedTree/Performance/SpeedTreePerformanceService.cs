...
namespace ProjectChimera.Systems.Services.SpeedTree.Performance
{
    ...
    public class SpeedTreePerformanceService : MonoBehaviour, ITickable, ISpeedTreePerformanceService
    {
        ...
        public void Initialize()
        {
            ...
            if (_mainCamera == null)
            {
                ChimeraLogger.LogError("No main camera found for SpeedTree performance service");
                return;
            }
        ...
        public void Shutdown()
        {
            ...
            IsInitialized = false;
            ChimeraLogger.Log("SpeedTreePerformanceService shutdown");
        }
        ...
        public void SetQualityLevel(SpeedTreeQualityLevel level)
        {
            ...
            ChimeraLogger.LogVerbose($"SpeedTree quality level set to: {level}");
        }
        ...
        public void OptimizeForDistance(float maxDistance)
        {
            ...
            ChimeraLogger.LogVerbose($"Optimized for distance: {maxDistance}");
        }
        ...
        public void ClearCache()
        {
            ...
            ChimeraLogger.LogVerbose("SpeedTree performance cache cleared");
        }
        ...
        public void AddSpeedTree(GameObject speedTree)
        {
            ...
            ChimeraLogger.LogVerbose($"Added SpeedTree for performance tracking: {speedTree.name}");
        }
        ...
        public void RemoveSpeedTree(GameObject speedTree)
        {
            ...
            ChimeraLogger.LogVerbose($"Removed SpeedTree from performance tracking: {speedTree.name}");
        }
        ...
        private void ClearAllSpeedTrees()
        {
            ...
            ChimeraLogger.LogVerbose("All SpeedTrees cleared from performance tracking");
        }
