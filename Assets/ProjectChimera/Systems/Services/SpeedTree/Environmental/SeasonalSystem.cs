...
namespace ProjectChimera.Systems.Services.SpeedTree.Environmental
{
    ...
    public class SeasonalSystem : MonoBehaviour
    {
        ...
        {
            ChimeraLogger.Log("[SeasonalSystem] Initializing SpeedTree seasonal system...");
            ...
            ChimeraLogger.Log($"[SeasonalSystem] SpeedTree seasonal system initialized. Current season: {_currentSeason}");
        }

        public void Shutdown()
        {
            ChimeraLogger.Log("[SeasonalSystem] Shutting down SpeedTree seasonal system...");

            _seasonalEffects.Clear();
            _plantSeasonalData.Clear();

            ChimeraLogger.Log("[SeasonalSystem] SpeedTree seasonal system shutdown complete");
        }
        ...
        public void UpdateSeasonalSystem()
        {
            ...
            {
                ChimeraLogger.LogError($"[SeasonalSystem] Failed to update seasonal system: {ex.Message}");
            }
        }
        ...
        private void TransitionToNextSeason()
        {
            ...
            ChimeraLogger.Log($"[SeasonalSystem] Season transition: {previousSeason} → {_currentSeason}");
        }
        ...
        public void SetSeason(Season season)
        {
            ...
            ChimeraLogger.Log($"[SeasonalSystem] Season forced: {previousSeason} → {_currentSeason}");
        }
        ...
        public void ApplySeasonalEffects(int plantId, Season season)
        {
            ...
            {
                ChimeraLogger.LogError($"[SeasonalSystem] Failed to apply seasonal effects to plant {plantId}: {ex.Message}");
            }
        }
        ...
        private void ApplySeasonalEffectsToRenderer(Renderer renderer, SeasonalEffects effects, float transitionProgress)
        {
            ...
            {
                ChimeraLogger.LogError($"[SeasonalSystem] Failed to apply seasonal effects to renderer: {ex.Message}");
            }
        }
        ...
        public void Tick(float deltaTime)
        {
            ...
            {
                ChimeraLogger.LogError($"[SeasonalSystem] Error in seasonal update loop: {ex.Message}");
            }
        }
