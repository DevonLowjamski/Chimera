...
namespace ProjectChimera.Systems.Cultivation
{
    ...
    public class CultivationEnvironmentalController : MonoBehaviour, ITickable, ICultivationService
    {
        ...
        public void Initialize()
        {
            ...
            ChimeraLogger.Log("[CultivationEnvironmentalController] Initializing environmental control system...");
            ...
            {
                // ChimeraLogger.LogWarning("[CultivationEnvironmentalController] EnvironmentManager not found - some features may be limited"); // EnvironmentManager not available
            }

            if (_zoneManager == null)
            {
                ChimeraLogger.LogWarning("[CultivationEnvironmentalController] CultivationZoneManager not found - using basic environmental control");
            }

            _lastEnvironmentalUpdate = Time.time;

            IsInitialized = true;
            ChimeraLogger.Log($"[CultivationEnvironmentalController] Initialized. Auto-control: {_enableAutoEnvironmentalControl}");
        }

        public void Shutdown()
        {
            ChimeraLogger.Log("[CultivationEnvironmentalController] Shutting down environmental control...");
            ...
            public void Tick(float deltaTime)
    {
        ...
        private void ApplyEnvironmentalEffectsToPlant(PlantInstanceSO plant, EnvironmentalConditions environment)
        {
            ...
            ChimeraLogger.Log($"[CultivationEnvironmentalController] Environmental stress for {plant.PlantName}: {totalStress:F2}");
        }
        ...
        public void OptimizeEnvironmentalConditions(string zoneId)
        {
            ...
            ChimeraLogger.Log($"[CultivationEnvironmentalController] Optimized environment for zone '{zoneId}'");
        }
