...
namespace ProjectChimera.Systems.Cultivation
{
    ...
    /// </summary>
    public class CultivationTester : ChimeraMonoBehaviour, ITickable
    {
        ...
        [Header("Test Assets")]
        [SerializeField] private object _testStrain;
            ...
            public void Tick(float deltaTime)
    {
        ...
        private bool TestPlantCreation(ref string results)
        {
            ...
            try
            {
                ...
                var plantId = _cultivationManager.AddPlant(_testStrain, testPosition);
                var testPlant = _cultivationManager.GetPlant(plantId);
        ...
        private bool TestEnvironmentalConditions(ref string results)
        {
            ...
            try
            {
                ...
                // Simplified: only use indoor default in early phase
                var outdoorEnv = indoorEnv;
                var stressEnv = indoorEnv;
        ...
        private bool TestPlantLifecycle(ref string results)
        {
            ...
            {
                // Create a test plant
                var plantId = _cultivationManager.AddPlant(_testStrain, Vector3.zero);
                var testPlant = _cultivationManager.GetPlant(plantId);
