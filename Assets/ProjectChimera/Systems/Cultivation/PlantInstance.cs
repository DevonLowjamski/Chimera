...
using EnvironmentManager = ProjectChimera.Systems.Environment.EnvironmentManager; // Use new EnvironmentManager
...
namespace ProjectChimera.Systems.Cultivation
{
    ...
    public class PlantInstance : MonoBehaviour
    {
        ...
        public void SetLastTraitExpression(TraitExpressionResult traitExpression)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} trait expression updated - Height: {traitExpression.HeightExpression:F2}, THC: {traitExpression.THCExpression:F2}, Yield: {traitExpression.YieldExpression:F2}");
        }
        ...
        public void ApplyHeightGrowthModifier(float heightModifier, float deltaTime)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} height growth applied - New height: {_expressedTraits.PlantHeight:F2}m");
        }
        ...
        public void ApplyPotencyModifier(float potencyModifier)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} potency modifier applied - Modifier: {potencyModifier:F2}");
        }
        ...
        public void ApplyCBDModifier(float cbdModifier)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} CBD modifier applied - Modifier: {cbdModifier:F2}");
        }
        ...
        public void ApplyYieldModifier(float yieldModifier)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} yield modifier applied - Modifier: {yieldModifier:F2}, New potential: {_yieldPotential:F2}");
        }
        ...
        public void ApplyGeneticFitnessModifier(float fitnessModifier)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} genetic fitness applied - Fitness: {fitnessModifier:F2}, Disease resistance: {_diseaseResistance:F2}");
        }
        ...
        public void ApplyTemperatureStress(float stressSeverity, float deltaTime)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} temperature stress applied - Severity: {stressSeverity:F2}, Damage: {stressDamage:F3}");
        }
        ...
        public void ApplyLightStress(float stressSeverity, float deltaTime)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} light stress applied - Severity: {stressSeverity:F2}, Damage: {stressDamage:F3}");
        }
        ...
        public void ApplyWaterStress(float stressSeverity, float deltaTime)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} water stress applied - Severity: {stressSeverity:F2}, Water level: {_waterLevel:F2}");
        }
        ...
        public void ApplyNutrientStress(float stressSeverity, float deltaTime)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} nutrient stress applied - Severity: {stressSeverity:F2}, Nutrient level: {_nutrientLevel:F2}");
        }
        ...
        public void ApplyAtmosphericStress(float stressSeverity, float deltaTime)
        {
            ...
            Debug.Log($"[PlantInstance] {PlantID} atmospheric stress applied - Severity: {stressSeverity:F2}, Stress level: {_stressLevel:F2}");
        }
        ...
        public void Sprout()
        {
            if (_currentGrowthStage == PlantGrowthStage.Seed)
            {
                ...
                _growthProgress = 0f;
                Debug.Log($"[PlantInstance] {PlantID} has sprouted!");
            }
        }
        ...
        */
        ...
        public void InitializeFromStrain(PlantStrainSO strain = null)
        {
            ...
            Debug.Log($"[PlantInstance] Initialized plant {_plantID} from strain {_strain.StrainName}");
        }
        ...
        */
        ...
        public EnvironmentalConditions GetCurrentEnvironmentalConditions()
        {
            ...
            if (gameManager != null)
            {
                var environmentManager = gameManager.GetManager<EnvironmentManager>();
        ...
        public void UpdateEnvironmentalAdaptation(EnvironmentalConditions conditions)
        {
            ...
            _environmentalSystem?.ProcessAdaptation(conditions, adaptationRate);
                ...
                Debug.Log($"[PlantInstance] Updated environmental adaptation for plant {_plantID} (fitness: {_environmentalFitness:F2})");
        }
        ...
        public bool ApplyStress(EnvironmentalStressSO stressSource, float intensity)
        {
            ...
            Debug.Log($"[PlantInstance] Applied stress '{stressSource.StressName}' to plant {_plantID} (Intensity: {intensity:F2})");
            return true;
        }
        ...
        public SystemsHarvestResults Harvest()
        {
            ...
            {
                Debug.LogWarning($"[PlantInstance] Plant {_plantID} is not ready for harvest");
                return null;
            }
            ...
            Debug.Log($"[PlantInstance] Harvested plant {_plantID}: {results?.TotalYieldGrams ?? 0}g");
            return results;
        }
        ...
        public bool AdvanceGrowthStage()
        {
            ...
            if (CanAdvanceToStage(nextStage))
            {
                ...
                Debug.Log($"[PlantInstance] Plant {_plantID} advanced to {_currentGrowthStage}");
        ...
        {
            _isActive = false;
            Debug.Log($"[PlantInstance] Plant {_plantID} died (Health: {_currentHealth:F2})");
