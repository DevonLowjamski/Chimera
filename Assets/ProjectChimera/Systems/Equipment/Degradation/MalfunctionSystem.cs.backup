...
namespace ProjectChimera.Systems.Equipment.Degradation
{
    ...
    public static class MalfunctionSystem
    {
        ...
        /// </summary>
        public static MalfunctionRiskAssessment EvaluateMalfunctionRisk(string equipmentId, Data.Equipment.EquipmentType equipmentType, float wearLevel, EnvironmentalStressFactors stressFactors)
        {
        ...
        public static EquipmentMalfunction GenerateMalfunction(
            string equipmentId,
            Data.Equipment.EquipmentType equipmentType,
            float wearLevel,
            ...
            OperationalStatus currentStatus)
        {
            ...
            ProjectChimera.Core.Logging.ChimeraLogger.Log("EQUIPMENT", $"Registered malfunction {malfunction.MalfunctionId} for {equipmentId}", null);
        ...
        public static RepairResult RepairMalfunction(string malfunctionId, float repairQuality)
        {
            ...
            float wearReduction = 0.2f * repairQuality;

            // Apply repair (minimal: assume success)
            ...
            if (repairSuccess)
            {
                ...
                ProjectChimera.Core.Logging.ChimeraLogger.Log("EQUIPMENT", $"Repaired malfunction {malfunctionId}", null);
        ...
        private static float CalculateEnvironmentalMalfunctionRisk(Data.Equipment.EquipmentType equipmentType, EnvironmentalStressFactors stressFactors)
        {
            var profile = EquipmentTypes.GetReliabilityProfile(equipmentType);
            ...
            // Temperature stress
            if (profile.EnvironmentalSensitivity != null && profile.EnvironmentalSensitivity.TryGetValue("Temperature", out float tempSensitivity))
            {
            ...
            // Humidity stress
            if (profile.EnvironmentalSensitivity != null && profile.EnvironmentalSensitivity.TryGetValue("Humidity", out float humiditySensitivity))
            {
        ...
        private static List<string> GenerateSymptoms(MalfunctionType type, MalfunctionSeverity severity, Data.Equipment.EquipmentType equipmentType)
        {
        ...
        private static float EstimateRepairCost(MalfunctionType type, MalfunctionSeverity severity, Data.Equipment.EquipmentType equipmentType)
        {
        ...
        private static TimeSpan EstimateRepairTime(MalfunctionType type, MalfunctionSeverity severity, Data.Equipment.EquipmentType equipmentType)
        {
        ...
        private static List<string> GenerateRequiredParts(MalfunctionType type, Data.Equipment.EquipmentType equipmentType)
        {
