...
{
    /// <summary>
    /// Refactored Analytics Manager - orchestrates all analytics components
    /// Maintains the original IAnalyticsService interface while using modular components
    /// </summary>
    public class RefactoredAnalyticsManager : DIChimeraManager, IAnalyticsService, ITickable
    {
        ...
        public static IAnalyticsService GetService()
        {
            ...
            {
                ChimeraLogger.LogWarning($"[RefactoredAnalyticsManager] Failed to get service from DI container: {ex.Message}");
                return null;
            }
        }
        ...
        protected override void OnManagerInitialize()
        {
            try
            {
                ...
                if (_enableDebugLogging)
                    ChimeraLogger.Log("[RefactoredAnalyticsManager] Analytics system initialized successfully");
            }
            catch (Exception ex)
            {
                ChimeraLogger.LogError($"[RefactoredAnalyticsManager] Failed to initialize analytics: {ex.Message}");
        ...
        protected override void OnManagerShutdown()
        {
            ...
            {
                ChimeraLogger.LogError($"[RefactoredAnalyticsManager] Error during shutdown: {ex.Message}");
            }

            _isInitialized = false;

            if (_enableDebugLogging)
                ChimeraLogger.Log("[RefactoredAnalyticsManager] Analytics system shutdown complete");
        }
        ...
        private void InitializeAllComponents()
        {
            ...
            if (_enableDebugLogging)
                ChimeraLogger.Log("[RefactoredAnalyticsManager] All components initialized");
        }
        ...
        private void UpdateMetrics()
        {
            try
            {
                ...
                if (_enableDebugLogging)
                    ChimeraLogger.Log("[RefactoredAnalyticsManager] Metrics update completed");
            }
            catch (Exception ex)
            {
                ChimeraLogger.LogError($"[RefactoredAnalyticsManager] Error updating metrics: {ex.Message}");
            }
        }
