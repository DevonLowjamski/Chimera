...
{
    /// <summary>
    /// Placement Payment Service - orchestrates all payment components
    ...
    /// </summary>
    public class PlacementPaymentService : MonoBehaviour, ITickable
    {
        ...
        private void InitializeComponents()
        {
            ...
            try
            {
                ...
                _isInitialized = true;
                ChimeraLogger.Log("[PlacementPaymentService] Payment service initialized with component architecture");
            }
            catch (System.Exception ex)
            {
                ChimeraLogger.LogError($"[PlacementPaymentService] Failed to initialize payment service: {ex.Message}");
            }
        }
        ...
        private void InitializeSystemReferences()
        {
            ...
            if (ServiceContainerFactory.Instance != null && ServiceContainerFactory.Instance.TryResolve<ICurrencyManager>(out var currencyService))
            {
                ...
                ChimeraLogger.LogDebug("[PlacementPaymentService] ICurrencyManager resolved from ServiceContainer");
            }
            else
            {
                ...
                if (_currencyManager != null && ServiceContainerFactory.Instance != null)
                {
                    ...
                    ChimeraLogger.LogDebug("[PlacementPaymentService] ICurrencyManager discovered and registered in ServiceContainer");
                }
            }
            ...
            if (ServiceContainerFactory.Instance != null && ServiceContainerFactory.Instance.TryResolve<ITradingManager>(out var tradingService))
            {
                ...
                ChimeraLogger.LogDebug("[PlacementPaymentService] ITradingManager resolved from ServiceContainer");
            }
            else
            {
                // Fallback to GameObject.Find for backward compatibility
                ...
                if (tradingManagerComponent is ITradingManager tradingManager && ServiceContainerFactory.Instance != null)
                {
                    ...
                    ChimeraLogger.LogDebug("[PlacementPaymentService] ITradingManager discovered and registered in ServiceContainer");
                }
            }
            ...
            {
                ChimeraLogger.LogWarning("[PlacementPaymentService] CurrencyManager not found - payment processing may not work");
            }
            if (_tradingManager == null)
            {
                ChimeraLogger.LogWarning("[PlacementPaymentService] TradingManager not found - trading features may not work");
            }
        }
        ...
        private void InitializeAllComponents()
        {
            ...
            ChimeraLogger.Log("[PlacementPaymentService] All payment components initialized");
        }
        ...
        private void ShutdownComponents()
        {
            ...
            {
                ChimeraLogger.LogError($"[PlacementPaymentService] Error during component shutdown: {ex.Message}");
            }

            ChimeraLogger.Log("[PlacementPaymentService] Payment service shutdown complete");
        }
