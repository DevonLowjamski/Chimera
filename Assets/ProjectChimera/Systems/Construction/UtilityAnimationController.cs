...
namespace ProjectChimera.Systems.Construction
{
    ...
    public class UtilityAnimationController
    {
        ...
        /// </summary>
        public IEnumerable<UtilityFlowIndicator> GetFlowIndicatorsForType(UtilityType utilityType)
        {
            return _flowIndicators.Where(fi => fi.Connection.UtilityType == utilityType);
        }
        ...
        private void UpdateFlowIndicatorProperties(UtilityFlowIndicator indicator)
        {
            if (indicator.VisualObject != null)
            {
                ...
                {
                    float flowRatio = indicator.Connection.CurrentFlow / indicator.Connection.Capacity;
                    var baseColor = _renderingCore.GetUtilityColor(indicator.Connection.UtilityType);
