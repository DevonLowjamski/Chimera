...
namespace ProjectChimera.Systems.Construction
{
    ...
    public class UtilityOverlayIntegration : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            {
                ChimeraLogger.Log("[UtilityOverlayIntegration] Initialized successfully");
            }
        }
        ...
        public void ShowUtilityOverlay(Vector3 position, float radius)
        {
            ...
            ChimeraLogger.Log("[UtilityOverlayIntegration] Utility overlay displayed");
        }
        ...
        public void HideUtilityOverlay()
        {
            ...
            ChimeraLogger.Log("[UtilityOverlayIntegration] Utility overlay hidden");
        }
        ...
        public void ClearUtilityOverlay()
        {
            ...
            ChimeraLogger.Log("[UtilityOverlayIntegration] Utility overlay cleared");
        }
        ...
        public void UpdateVisibilitySettings(bool showElectrical, bool showWater, bool showAir)
        {
            ...
            ChimeraLogger.Log("[UtilityOverlayIntegration] Visibility settings updated");
        }
