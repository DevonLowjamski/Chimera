...
namespace ProjectChimera.Systems.Construction
{
    ...
    public class SchematicManager : MonoBehaviour
    {
        ...
        public void StartSchematicCreation(string schematicName, string description = "")
        {
            ...
            ChimeraLogger.Log($"[SchematicManager] Started creating schematic: {schematicName}");
        }
        ...
        public void CancelSchematicCreation()
        {
            ...
            ChimeraLogger.Log("[SchematicManager] Cancelled schematic creation");
        }
        ...
        public void AddObjectToSchematic(GameObject obj, Vector3 position, Quaternion rotation)
        {
            ...
            {
                ChimeraLogger.Log($"[SchematicManager] Excluded genetic component: {obj.name}");
                return;
            }
            ...
            ChimeraLogger.Log($"[SchematicManager] Added object to schematic: {obj.name}");
        }
        ...
        public void RemoveObjectFromSchematic(GameObject obj)
        {
            ...
            ChimeraLogger.Log($"[SchematicManager] Removed object from schematic: {obj.name}");
        }
        ...
        public bool SaveCurrentSchematic()
        {
            ...
            {
                ChimeraLogger.LogWarning("[SchematicManager] No schematic to save");
                return false;
            }

            if (_currentSchematic.Objects.Count == 0)
            {
                ChimeraLogger.LogWarning("[SchematicManager] Schematic has no objects to save");
                return false;
            }
            ...
            ChimeraLogger.Log($"[SchematicManager] Saved schematic: {_currentSchematic.SchematicName}");
        ...
        public Schematic LoadSchematic(string schematicId)
        {
            ...
            {
                ChimeraLogger.Log($"[SchematicManager] Loaded schematic: {schematic.SchematicName}");
                return schematic;
            }

            ChimeraLogger.LogWarning($"[SchematicManager] Schematic not found: {schematicId}");
            return null;
        }
        ...
        public Schematic LoadSchematicByName(string schematicName)
        {
            ...
            if (schematic != null)
            {
                ChimeraLogger.Log($"[SchematicManager] Loaded schematic by name: {schematicName}");
                return schematic;
            }

            ChimeraLogger.LogWarning($"[SchematicManager] Schematic not found by name: {schematicName}");
            return null;
        }
        ...
        public bool DeleteSchematic(string schematicId)
        {
            if (_savedSchematics.Remove(schematicId))
            {
                ...
                ChimeraLogger.Log($"[SchematicManager] Deleted schematic: {schematicId}");
                return true;
            }

            ChimeraLogger.LogWarning($"[SchematicManager] Failed to delete schematic: {schematicId}");
            return false;
        }
        ...
        public List<GameObject> InstantiateSchematic(Schematic schematic, Vector3 position, Quaternion rotation)
        {
            if (schematic == null)
            {
                ChimeraLogger.LogWarning("[SchematicManager] No schematic to instantiate");
            ...
            foreach (var schematicObject in schematic.Objects)
            {
                ...
                if (prefab == null)
                {
                    ChimeraLogger.LogWarning($"[SchematicManager] Could not load prefab: {schematicObject.PrefabName}");
                    continue;
                }
            ...
            ChimeraLogger.Log($"[SchematicManager] Instantiated schematic '{schematic.SchematicName}' with {instantiatedObjects.Count} objects");
        ...
        public bool ShareSchematic(string schematicId, int skillPointCost)
        {
            ...
            {
                ChimeraLogger.LogWarning("[SchematicManager] Schematic sharing is disabled");
                return false;
            }
            ...
            ChimeraLogger.Log($"[SchematicManager] Shared schematic: {schematic.SchematicName}");
            return true;
        }
        ...
        public bool ImportSharedSchematic(Schematic sharedSchematic)
        {
            if (sharedSchematic == null || !_savedSchematics.ContainsKey(sharedSchematic.SchematicID))
            {
                ...
                ChimeraLogger.Log($"[SchematicManager] Imported shared schematic: {sharedSchematic.SchematicName}");
                return true;
            }

            ChimeraLogger.LogWarning($"[SchematicManager] Schematic already exists: {sharedSchematic.SchematicID}");
            return false;
        }
        ...
        private GameObject LoadPrefab(string prefabName)
        {
            ...
            // For now, try to find in resources
        ...
        private void SaveSchematicToFile(Schematic schematic)
        {
            ...
            {
                ChimeraLogger.LogError($"[SchematicManager] Failed to save schematic file: {ex.Message}");
            }
        }
        ...
        private void LoadSavedSchematics()
        {
            ...
            ChimeraLogger.Log("[SchematicManager] Loaded saved schematics");
        }
        ...
        public void ClearAllSchematics()
        {
            ...
            ChimeraLogger.Log("[SchematicManager] Cleared all schematics");
        }
    }
