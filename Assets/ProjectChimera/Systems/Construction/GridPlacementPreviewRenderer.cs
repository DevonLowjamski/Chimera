...
namespace ProjectChimera.Systems.Construction
{
    ...
    public class GridPlacementPreviewRenderer : MonoBehaviour
    {
        ...
        private void InitializeComponents()
        {
            ...
            if (_gridSystem == null)
                Debug.LogWarning("[GridPlacementPreviewRenderer] GridSystem not found");
        }
        ...
        public void ShowPreview(GridPlaceable placeable)
        {
            ...
            Debug.Log($"[GridPlacementPreviewRenderer] Showing preview for {placeable.name}");
        }
        ...
        {
            ClearAllPreviews();
            Debug.Log("[GridPlacementPreviewRenderer] Preview hidden");
        }
        ...
        {
            Debug.Log($"[GridPlacementPreviewRenderer] Preview position updated to {newPosition}");
        ...
        public void UpdateValidationVisuals(PlacementValidationResult result)
        {
            ...
            Debug.Log($"[GridPlacementPreviewRenderer] Validation visuals updated: {(result.IsValid ? "Valid" : "Invalid")}");
