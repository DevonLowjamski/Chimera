...
namespace ProjectChimera.Systems.Construction
{
    ...
    /// </summary>
    public class SchematicUnlockManager : ChimeraManager, ITickable{
        ...
        protected override void OnManagerInitialize()
        {
            ...
            _ = LoadSchematicsDataAsync(); // Fire and forget - don't block initialization
        ...
        public bool UnlockSchematic(SchematicSO schematic)
        {
            ...
            if (schematic.SkillPointCost > 0)
            {
                var progressionManager = GameManager.Instance?.GetComponent<MonoBehaviour>() as IProgressionManager ??
                                        ServiceContainerFactory.Instance?.TryResolve<IProgressionManager>();
        ...
        private async Task LoadSchematicsDataAsync()
        {
            ...
            {
                LogInfo($"[SchematicUnlockManager] Failed to load schematics: {ex.Message}");
            }
        }
