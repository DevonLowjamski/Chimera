...
namespace ProjectChimera.Core.Updates
{
    ...
    public static class TickPriority
    {
        ...
        public const int CacheValidation = 300;
        public const int CacheOptimization = 310;
        public const int CacheManager = 320;
    ...
    public abstract class TickableBase : ITickable
    {
        ...
        public virtual int TickPriority => _priority;
        public virtual bool IsTickable => _enabled;
    ...
    public abstract class TickableMonoBehaviour : MonoBehaviour, ITickable
    {
        ...
        public virtual int TickPriority => _priority;
        public virtual bool IsTickable => _enabled && gameObject.activeInHierarchy;
        ...
        private void Update()
        {
            ...
            Logger.LogWarning("ITICKABLE", "Update() called on TickableMonoBehaviour. Use Tick() instead.", this);
        }
    }
