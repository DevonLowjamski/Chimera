...
namespace ProjectChimera.Core
{
    ...
    public class TimeScale : ITimeScale
    {
        ...
        public void SetSpeedLevel(TimeSpeedLevel newSpeedLevel)
        {
            ...
            ChimeraLogger.Log($"[TimeScale] Speed level changed from {_currentSpeedLevel} to {newSpeedLevel}");
        ...
        public string GetEstimatedRealTime(float gameTimeSeconds)
        {
            ...
            return TimeManager.FormatDuration(realTimeSeconds);
        }

        public void SetSpeedPenaltiesEnabled(bool enabled)
        {
            _enableSpeedPenalties = enabled;
            ChimeraLogger.Log($"[TimeScale] Speed penalties {(enabled ? "enabled" : "disabled")}");
        ...
        public void SetPenaltySeverityMultiplier(float multiplier)
        {
            ...
            ChimeraLogger.Log($"[TimeScale] Penalty severity set to {_penaltySeverityMultiplier:F2}");
