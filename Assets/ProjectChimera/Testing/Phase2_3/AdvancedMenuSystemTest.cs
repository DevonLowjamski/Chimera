...
namespace ProjectChimera.Testing.Phase2_3
{
    ...
    public class AdvancedMenuSystemTest : MonoBehaviour
    {
        ...
        private void Start()
        {
            ChimeraLogger.LogWarning("[AdvancedMenuSystemTest] This is a legacy test file. Please use AdvancedMenuSystemTestCoordinator instead.");
        ...
        {
            ChimeraLogger.LogWarning("[AdvancedMenuSystemTest] Redirecting to AdvancedMenuSystemTestCoordinator...");
            ...
            {
                ChimeraLogger.LogError("[AdvancedMenuSystemTest] Test coordinator not available!");
            }
        }
